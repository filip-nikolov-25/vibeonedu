...
import PreviewCourseBeforeRegistration from "@/components/base/popup/PreviewCourseBeforeRegistration";
import Image from "next/image";

export default function Popup(): JSX.Element {
  return (
    <div className="p-6 w-3/6 h-[100vh] flex flex-col">
      <div className="w-full">{/* <WelcomeHeader /> */}</div>
